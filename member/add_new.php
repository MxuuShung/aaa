...
<?php
$email =  $first_name = $last_name = $password = $confirm_password = $birthday = $area = '';
...
<body>
    ...
    <div class="container-fluid MG-add-background-1">
        <div class="row MG-row justify-content-center">
            <div class="align-self-center MG-add-box ">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <!--讓title、body、footer均分垂直-->
                    <div class="MG-add-box-padding d-flex flex-column bd-highlight">
                        <!--1.title-->
                        <div class="MG-add-box-title justify-content-between">
                            
                            <div class="MG-add-box-title-left align-self-center">
                                <h1>註冊</h1>
                            </div>
                            <!--title 標題+logo-->
                            <div class="MG-add-box-title-right">
                                <a href="#"><img class="MG-add-box-title-right-img" src="../image/member/LOGO_WHITE.svg" alt=""></a>
                            </div>
                        </div>
                        <div class="MG-member-line"></div>
                        <div class="btnLine3"></div>
                        <!--2.body 欄位-->
                        <div class="MG-add-box-body mt-4">
                            <!--可以考慮用justify-content-around-->
                            <div class="row d-flex justify-content-between MG-add-box-body-name">
                                <div class="MG-add-box-body-col mt-4">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        <label>名稱：</label><br />
                                        <input class="MG-add-box-body-col-input-style" type="text" name="first_name" value="<?php echo $first_name ?>" placeholder="必填">
                                ...
                                <div class="MG-add-box-body-col mt-4">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        <label>姓氏：</label><br />
                                        <input class="MG-add-box-body-col-input-style" type="text" name="last_name" value="<?php echo $last_name ?>" placeholder="必填">
                                        <span><?php echo $last_name_err ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row d-flex justify-content-between MG-add-box-body-password">
                                <div class="MG-add-box-body-col mt-4" id="show_hide_password">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        <label>密碼：</label><br />
                                        <input class="MG-add-box-body-col-input-style" type="password" name="password" value="<?php echo $password ?>" placeholder="密碼需大於6個字">
                                ...
                                <div class="MG-add-box-body-col mt-4">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        <label>確認密碼：</label><br />
                                        <input class="MG-add-box-body-col-input-style" type="password" name="confirm_password" value="<?php echo $confirm_password ?>" placeholder="再次輸入密碼">
                            ...
                            <div class="row d-flex justify-content-between MG-add-box-body-other">
                                <div class="MG-add-box-body-col mt-4">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        <label>生日：</label><br />
                                        <input class="MG-add-box-body-col-input-style" type="date" name="birthday" value="<?php echo $birthday ?>" placeholder="必填">
                                ...
                                <div class="MG-add-box-body-col mt-4">
                                    <div class="form-group  MG-add-box-body-col-input">
                                        ...
                                        <select onChange="citychange(this.form)" name="area" class="">
                        ...
                        <div class="mt-1 MG-member-line-bottom mt-4"></div>
